...
import { Platform, SafeAreaView, ScrollView, StyleSheet, TextInput, View } from 'react-native'
import base64 from 'react-native-base64'
import type { TestStateType } from '../../../types'
import { BLEService } from '../../../services'
import type { MainStackParamList } from '../../../navigation/navigators'
import { AppButton, ScreenDefaultContainer, TestStateDisplay } from '../../../components/atoms'
...
type DevicenRFTestScreenProps = StackScreenProps<MainStackParamList, 'DEVICE_NRF_TEST_SCREEN'>
...
export function DevicenRFTestScreen(_props: DevicenRFTestScreenProps) {
  ...
  const onDeviceFound = (device: Device) => {
    if (device.name?.toLocaleLowerCase() === expectedDeviceName.toLocaleLowerCase() && device.name.length > 0) {
