...
type DeviceOnDisconnectTestScreenProps = StackScreenProps<MainStackParamList, 'DEVICE_ON_DISCONNECT_TEST_SCREEN'>
...
export function DeviceOnDisconnectTestScreen(_props: DeviceOnDisconnectTestScreenProps) {
  ...
  const checkDeviceName = (device: Device) =>
    device.name?.toLocaleLowerCase() === expectedDeviceName.toLocaleLowerCase() && device.name.length > 0
