...
import { StyleSheet, Text, View, FlatList, Platform,Image } from 'react-native';
    ...
    <View style={styles.container}>
      <Tester>
        <TestSuite name='加载速度测试'>
          ...
          <TestCase itShould='preload'><Text onPress={preloadOnPress} style={styles.label}>prefetch 预加载</Text></TestCase>
        </TestSuite>
      </Tester>
