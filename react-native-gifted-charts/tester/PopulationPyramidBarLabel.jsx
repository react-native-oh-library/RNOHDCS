...
export default function () {
  ...
  const populationPyramidProp = [
    ...
    { barLabelFontFamily: 'cursive', showValuesAsBarLabels: true, leftBarLabelSuffix: 'money', rightBarLabelSuffix: 'money' },
    { barLabelFontFamily: 'auto', showValuesAsBarLabels: true, leftBarLabelSuffix: 'money', rightBarLabelSuffix: 'money' },
