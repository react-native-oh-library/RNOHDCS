          ...
          <TestSuite name="Basic">
            <TestCase itShould="测试direction属性值column" tags={['dev']}>
              <View style={styles.section}>
                ...
                <View style={styles.subSection}>
                  <HStack space={3} justifyContent="center" direction="column">
                    <Center
                      h="40"
                      w="20"
                      bg="primary.300"
            ...
            <TestCase itShould="测试direction属性值column-reverse" tags={['dev']}>
              <View style={styles.section}>
                <Text>Basic</Text>
                <View style={styles.subSection}>
                  <HStack space={3} justifyContent="center" direction='column-reverse'>
                    <Center
                      h="40"
                      w="20"
                      bg="primary.300"
            ...
            <TestCase itShould="测试direction属性值row" tags={['dev']}>
              <View style={styles.section}>
                <Text>Basic</Text>
                <View style={styles.subSection}>
                  <HStack space={3} justifyContent="center" direction="row">
                    <Center
                      h="40"
                      w="20"
                      bg="primary.300"
            ...
            <TestCase itShould="测试direction属性值row-reverse" tags={['dev']}>
              <View style={styles.section}>
                <Text>Basic</Text>
                <View style={styles.subSection}>
                  <HStack space={3} justifyContent="center" direction="row-reverse">
                    <Center
                      h="40"
                      w="20"
                      bg="primary.300"
