      ...
      <Tester>
        <ScrollView style={styles.content}>
          ...
          <TestSuite name="useBreakpointValue">
            <TestCase itShould="useBreakpointValue" tags={['dev']}>
              <View style={styles.section}>
          ...
          <TestSuite name="useContrastText和useAccessibleColors">
            <TestCase
              itShould="useContrastText和useAccessibleColors"
              tags={['dev']}>
              <View style={styles.section}>
                <Text>useContrastText和useAccessibleColors</Text>
                <Center>
                  ...
                  <HStack mt="6" space="3">
                    ...
                    <Switch
                      onValueChange={toggleAccessibleColors}
