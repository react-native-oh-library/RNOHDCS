...
import ChartListTest from './ChartTest';
...
import StickyFormExampleTest from './StickyFormExampleTest';
import { StickyForm } from 'react-native-largelist';
import { messages } from '../largelist/DataSource';

export default function StickyFormTest() {
    return (
        <Tester>
            <ScrollView
...
const UpdateTimeIntervalTest = () => {
    ...
    const _renderSection = (section: number) => {
        return <View></View>;
    };
