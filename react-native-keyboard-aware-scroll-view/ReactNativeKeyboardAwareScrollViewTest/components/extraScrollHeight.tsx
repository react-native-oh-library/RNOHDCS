...
export const extraScrollHeight: React.FC = (): JSX.Element => {
            ...
            <TestCase
                ...
                arrange={({ setState }) => {
                    ...
                    return (
                        ...
                        >
                            <TextInput keyboardType='numeric' style={styles.input} placeholder='请输入extraScrollHeight' onEndEditing={(val) => { setExtraScrollHeight(Number(val.nativeEvent.text)); setState(true) }} />
                            {
                                Labels.map(item => {
