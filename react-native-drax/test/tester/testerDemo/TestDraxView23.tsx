  ...
  return (
    <>
      <Tester children={undefined}>
        <TestCase
          itShould="DraxView组件:otherDraggingWithoutReceiverStyle(拖拽蓝色正方形未位于绿色正方形上时应用于红色正方形的样式-增加圆角)"
          tags={['C_API']}>
          <View style={{height: 500}}>
            <DraxViewBaseComponent
              ...
              otherDraggingWithoutReceiverStyle={
                styles.otherDraggingWithoutReceiverStyle
              }
