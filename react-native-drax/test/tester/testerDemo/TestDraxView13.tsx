  ...
  return (
    <>
      ...
      <Tester children={undefined}>
        <TestCase
          itShould="DraxView组件:receiverPayload(手指拖动蓝色正方形进入绿色正方形正上方然后释放,此时接收到绿色正方形传递的receiverPayload参数'receiverPayload')"
          tags={['C_API']}>
