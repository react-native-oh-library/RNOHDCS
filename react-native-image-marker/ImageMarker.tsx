...
export const ImageMarker = () => {
  ...
  // global scale
  const [url_globalscale0_5_text, seturl_globalscale0_5_text] = useState('');
  const [url_globalscale1_5_text, seturl_globalscale1_5_text] = useState('');
  // text alain
  ...
  // textBackgroundStyle
  // global scale
  const text_options_globalScale_0_5: TextMarkOptions = {
    backgroundImage: { src: require('./assets/code-images/1.png') },
    scale:0.5,
    watermarkTexts: [{
      text: 'test text'
  ...
  const text_options_globalScale_1_5: TextMarkOptions = {
    backgroundImage: { src: require('./assets/code-images/1.png') },
    scale:1.5,
    watermarkTexts: [{
      text: 'test text'
  ...
  // global scale
  const markTextGlobalScale0_5 = () => {
    Marker.markText(text_options_globalScale_0_5).then((result) => {
      seturl_globalscale0_5_text(result)
    }).catch(error => {
      console.log('error', error)
    })
  }
  const markTextGlobalScale1_5 = () => {
    Marker.markText(text_options_globalScale_1_5).then((result) => {
      seturl_globalscale1_5_text(result)
    }).catch(error => {
      console.log('error', error)
    })
  }
      ...
      <ScrollView>
        <TestSuite name='react-native-image-marker'>
          ...
          <TestCase key={"mark text "}
            itShould=' text_global_scale_0_5 '
            tags={['C_API']}>
            <View style={styles.body}>
              <View style={styles.sectionContainer}>
                <Text style={styles.sectionTitle}>
                ...
                <Button
                  title="text_global_scale_0_5 "
                  color="#9a73ef"
                  onPress={markTextGlobalScale0_5}
                />
                <Text style={styles.sectionTitle}>
                  {url_globalscale0_5_text}
                </Text>
                <Image resizeMode='contain' source={{ uri: url_globalscale0_5_text, width: 300, height: 300 }} />
              </View>
            </View>
          </TestCase>
          
          <TestCase key={"mark text "}
            itShould=' text_global_scale_1_5 '
            tags={['C_API']}>
            <View style={styles.body}>
              <View style={styles.sectionContainer}>
                <Text style={styles.sectionTitle}>
                ...
                <Button
                  title="text_global_scale_1_5 "
                  color="#9a73ef"
                  onPress={markTextGlobalScale1_5}
                />
                <Text style={styles.sectionTitle}>
                  {url_globalscale1_5_text}
                </Text>
                <Image resizeMode='contain' source={{ uri: url_globalscale1_5_text, width: 300, height: 300 }} />
              </View>
            </View>
          </TestCase>
