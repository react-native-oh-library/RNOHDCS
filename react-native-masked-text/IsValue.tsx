                            ...
                            <View style={{ flexDirection: 'column' }}>
                                ...
                                <Button
                                    ...
                                    onPress={() => {
                                        ...
                                        console.log(MaskService.isValid('custom', valid7.value, {
                                            mask: '999 AAA SSS ***',
                                            validator: function (value, settings) {
                                                return true
                                            },
                            ...
                            <View style={{ flexDirection: 'column' }}>
                                ...
                                <Button
                                    ...
                                    onPress={() => {
                                        ...
                                        console.log(MaskService.isValid('cnpj', valid6.value, {}), valid6.value);
                            ...
                            <View style={{ flexDirection: 'column' }}>
                                ...
                                <Button
                                    ...
                                    onPress={() => {
                                        ...
                                        console.log(MaskService.isValid('credit-card', valid5.value, {
                                            obfuscated: false,
                                            issuer: 'amex'
                                        }), valid5.value);
                            ...
                            <View style={{ flexDirection: 'column' }}>
                                ...
                                <Button
                                    ...
                                    onPress={() => {
                                        ...
                                        console.log(MaskService.isValid('cpf', valid2.value, {}), '------123');
                            ...
                            <View style={{ flexDirection: 'column' }}>
                                ...
                                <Button
                                    ...
                                    onPress={() => {
                                        ...
                                        console.log(MaskService.isValid('money', valid3.value, {
                                            unit: 'US$',
                                            separator: '.',
                                            delimiter: ','
                                        }));
                            ...
                            <View style={{ flexDirection: 'column' }}>
                                ...
                                <Button
                                    ...
                                    onPress={() => {
                                        ...
                                        console.log(MaskService.isValid('zip-code', valid4.value, {}));
                            ...
                            <View style={{ flexDirection: 'column' }}>
                                ...
                                <Button
                                    ...
                                    onPress={() => {
                                        ...
                                        console.log(MaskService.isValid('only-numbers', valid8.value, {}));
                            ...
                            <View style={{ flexDirection: 'column' }}>
                                ...
                                <Button
                                    ...
                                    onPress={() => {
                                        ...
                                        console.log(MaskService.isValid('datetime', valid9.value, { format: 'YYYY/MM/DD' }));
