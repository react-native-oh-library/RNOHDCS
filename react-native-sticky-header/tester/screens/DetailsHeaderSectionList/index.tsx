...
//引入组件测试demo
import DetailsHeaderSectionListDemoDefault from './DefaultDemo/index';
//定义组件测试testID
const testIdObject = {
  default: 'DetailsHeaderSectionListDemoDefault_testID',
};
const defaultRouter = {
  routeName: CHILDROUTES.DetailsHeaderSectionListDemoDefault,
  label: 'DetailsHeaderSectionList默认组件',
...
const DetailsHeaderSectionListDemoScreen: React.FC = () => {
  return (
    <>
      <SafeAreaView>
        <StatusBar
        ...
        <View style={styles.container}>
          <View style={styles.header}>
            <Text>DetailsHeaderSectionList组件测试页面</Text>
          </View>
          <ScrollView>
...
export default DetailsHeaderSectionListDemoScreen;
export {DetailsHeaderSectionListDemoDefault};
