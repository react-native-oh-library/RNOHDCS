...
//引入组件测试demo
import AvatarHeaderScrollViewDemoDefault from './DefaultDemo/index';
//定义组件测试testID
const testIdObject = {
  default: 'AvatarHeaderScrollViewDemoDefault_testID',
};
const defaultRouter = {
  routeName: CHILDROUTES.AvatarHeaderScrollViewDemoDefault,
  label: 'AvatarHeaderScrollView默认组件',
  testID: testIdObject.default,
  title: 'AvatarHeaderScrollView默认组件',
  testProps: {
    ...
    subtitle: 'Coffee buff.Web enthusiast....文字',
    subtitleStyle: '设置subtitle文字颜色为白色',
  },
};
      ...
      <SafeAreaView>
        ...
        <View style={styles.container}>
          <View style={styles.header}>
            <Text>AvatarHeaderScrollView组件测试页面</Text>
          </View>
          <ScrollView>
...
export {AvatarHeaderScrollViewDemoDefault};
