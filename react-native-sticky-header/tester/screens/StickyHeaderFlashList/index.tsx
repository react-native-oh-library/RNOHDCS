...
//引入组件测试demo
import StickyHeaderFlashListDemoDefault from './DefaultDemo/index';
//定义组件测试testID
const testIdObject = {
  default: 'StickyHeaderFlashListDemoDefault_testID',
};
const defaultRouter = {
  routeName: CHILDROUTES.StickyHeaderFlashListDemoDefault,
  label: 'StickyHeaderFlashList默认组件',
  testID: testIdObject.default,
  title: '默认组件StickyHeaderFlashListDemoDefault(设置对比属性值)',
  testProps: {
...
const StickyHeaderFlashListDemoScreen: React.FC = () => {
  return (
    <>
      <SafeAreaView>
        <StatusBar
        ...
        <View style={styles.container}>
          <View style={styles.header}>
            <Text>StickyHeaderFlashList组件测试页面</Text>
          </View>
          <ScrollView>
...
export default StickyHeaderFlashListDemoScreen;
export {StickyHeaderFlashListDemoDefault};
