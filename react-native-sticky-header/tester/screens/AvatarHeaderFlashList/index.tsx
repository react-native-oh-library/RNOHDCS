...
//引入组件测试demo
import AvatarHeaderFlashListDemoDefault from './DefaultDemo/index';
import AvatarHeaderFlashListDemoChild1 from './TestDemo/ChildDemo1';
import AvatarHeaderFlashListDemoChild2 from './TestDemo/ChildDemo2';
//定义组件测试testID
const testIdObject = {
  default: 'AvatarHeaderFlashListDemoScreenDefault_testID',
  child1: 'AvatarHeaderFlashListDemoScreenChild1_testID',
  child2: 'AvatarHeaderFlashListDemoScreenChild2_testID',
};
const defaultRouter = {
  routeName: CHILDROUTES.AvatarHeaderFlashListDemoDefault,
  label: 'AvatarHeaderFlashList默认组件',
...
const childRouter1 = {
  routeName: CHILDROUTES.AvatarHeaderFlashListDemoChild1,
  label: 'AvatarHeaderFlashList测试子组件1',
...
const childRouter2 = {
  routeName: CHILDROUTES.AvatarHeaderFlashListDemoChild2,
  label: 'AvatarHeaderFlashList测试子组件2',
  testID: testIdObject.child2,
  title: '测试组件AvatarHeaderFlashListDemoChild2(设置对比属性值)',
  testProps: {
...
const AvatarHeaderFlashListDemoScreen: React.FC = () => {
  return (
    <>
      <SafeAreaView>
        <StatusBar
        ...
        <View style={styles.container}>
          <View style={styles.header}>
            <Text>AvatarHeaderFlashList组件测试页面</Text>
          </View>
          <ScrollView>
...
export default AvatarHeaderFlashListDemoScreen;
export {
