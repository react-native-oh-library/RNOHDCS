...
//引入组件测试demo
import YodaDemoDefault from './DefaultDemo/index';
//定义组件测试testID
const testIdObject = {
  default: 'YodaDemoDefault_testID',
};
const defaultRouter = {
  routeName: CHILDROUTES.YodaDemoDefault,
  label: 'Yoda默认组件',
  testID: testIdObject.default,
  title: '默认组件YodaDemoDefault',
  testProps: {
