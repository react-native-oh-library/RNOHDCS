        ...
        <View style={{ flex: 1 }}>
                ...
                <ScrollView>
                    <TestSuite name="react-native-drag-sort-AutoDragSort">
                        <TestCase
                            ...
                            arrange={({ setState }) => {
                                return <Button title='setIsDragFreely(true)' onPress={() => {
                        ...
                        <TestCase
                            ...
                            arrange={({ setState }) => {
                                return <Button title='setMarginChildrenTop(5)' onPress={() => {
                        ...
                        <TestCase
                            ...
                            arrange={({ setState }) => {
                                return <Button title='setMarginChildrenBottom(5)' onPress={() => {
                        ...
                        <TestCase
                            ...
                            arrange={({ setState }) => {
                                return <Button title='setMarginChildrenLeft(5)' onPress={() => {
                        ...
                        <TestCase
                            ...
                            arrange={({ setState }) => {
                                return <Button title='setMarginChildrenRight(5)' onPress={() => {
                        ...
                        <TestCase
                            ...
                            arrange={({ setState }) => {
                                return <Button title='setFixedItems([0, 1] as any)' onPress={() => {
                        ...
                        <TestCase
                            ...
                            arrange={({ setState }) => {
                                return <Button title='setDelayLongPress(1000)' onPress={() => {
                        ...
                        <TestCase
                            ...
                            arrange={({ setState }) => {
                                return <Button title='setMaxScale(2)' onPress={() => {
                        ...
                        <TestCase
                            ...
                            arrange={({ setState }) => {
                                return <Button title='setMinOpacity(0.3)' onPress={() => {
                                    setMinOpacity(0.3); setState(true);
                                }} />;
                            }}
                            assert={async ({ expect, state }) => {
                                expect(state).to.be.true;
                        ...
                        <TestCase
                            ...
                            arrange={({ setState }) => {
                                return <Button title='setScaleDuration(500)' onPress={() => {
                        ...
                        <TestCase
                            ...
                            arrange={({ setState }) => {
                                return <Button title='setSlideDuration(1000)' onPress={() => {
                        ...
                        <TestCase
                            ...
                            arrange={({ setState }) => {
                                return <AutoDragSortableView {...requiredProps} dataSource={GeneratingData()} isDragFreely={false}
                        ...
                        <TestCase
                            ...
                            arrange={({ setState }) => {
                                return <Button title='改变数据源' onPress={() => {
                                    const list = []
                        ...
                        <TestCase
                            ...
                            arrange={({ setState }) => {
                                return <Button title='setAutoThrottle(1)' onPress={() => {
                        ...
                        <TestCase
                            ...
                            arrange={({ setState }) => {
                                return <Button title='setAutoThrottleDuration(200)' onPress={() => {
                                    setAutoThrottleDuration(200); setState(true);
                                }} />;
                            }}
                            assert={async ({ expect, state }) => {
                                expect(state).to.be.true;
                        ...
                        <TestCase
                            ...
                            arrange={({ setState }) => {
                                return <Button title='setRenderHeaderView(HeaderComp)' onPress={() => {
                                    setRenderHeaderView(HeaderComp); setHeaderViewHeight(30); setState(true);
                                }} />;
                            }}
                            assert={async ({ expect, state }) => {
                                expect(state).to.be.true;
                        ...
                        <TestCase
                            ...
                            arrange={({ setState }) => {
                                return <Button title='setRenderBottomView(FooterComp)' onPress={() => {
                                    setRenderBottomView(FooterComp); setBottomViewHeight(30), setState(true);
                                }} />;
                            }}
                            assert={async ({ expect, state }) => {
                                expect(state).to.be.true;
                        ...
                        <TestCase
                            ...
                            arrange={({ setState }) => {
                                return (
                                    <View style={{ flex: 1 }}>
                                        <AutoDragSortableView {...requiredProps} dataSource={GeneratingData()} isDragFreely={false}
                                            onDragStart={() => {
                        ...
                        <TestCase
                            ...
                            arrange={({ setState }) => {
                                return (
                                    <View style={{ flex: 1 }}>
                                        <AutoDragSortableView {...requiredProps} dataSource={GeneratingData()} isDragFreely={false}
                                            onDragging={() => { Alert.alert('onDragging事件触发了'); setState(true) }} renderItem={item => {
                                                return <View key={item.id} style={STYLES.box}>
                                                    <Text style={STYLES.text}>{item.title}</Text>
                                                </View>;
                                            }}
                        ...
                        <TestCase
                            ...
                            arrange={({ setState }) => {
                                return <Button title='setSortable(!sortable)' onPress={() => {
                                    setSortable(!sortable); setState(true);
                                }} />;
                            }}
                            assert={async ({ expect, state }) => {
                                expect(state).to.be.true;
            ...
            <View style={{ backgroundColor: '#fff', height: 360, padding: 5 }}>
                <AutoDragSortableView {...requiredProps}
                    marginChildrenTop={marginChildrenTop} marginChildrenBottom={marginChildrenBottom}
                    marginChildrenLeft={marginChildrenLeft} marginChildrenRight={marginChildrenRight}
                    scaleStatus={scaleStatus as any} fixedItems={fixedItems} delayLongPress={delayLongPress}
                    isDragFreely={isDragFreely} maxScale={maxScale} minOpacity={minOpacity} scaleDuration={scaleDuration}
                    slideDuration={slideDuration} sortable={sortable} autoThrottle={autoThrottle} autoThrottleDuration={autoThrottleDuration}
                    renderHeaderView={renderHeaderView} headerViewHeight={headerViewHeight} renderBottomView={renderBottomView} bottomViewHeight={bottomViewHeight}
                    renderItem={item => {
                        return <View key={item.id} style={STYLES.box}>
                            <Text style={STYLES.text}>{item.title}</Text>
                        </View>;
...
export default T_AutoDragSortDemo