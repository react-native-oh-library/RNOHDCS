...
export default class TextFieldScreen extends Component {
    ...
    return (
      <>
        <View marginV-s3>
          ...
          <View row centerV>
            <Text marginR-s4 $textPrimary>
              Preset:
            </Text>
            <SegmentedControl
              segments={[{label: 'Underline'}, {label: 'Outline'}]}
              onChangeIndex={this.onChangeIndexFieldStyle}
            />
          </View>
        </View>
        ...
        <View row centerV spread>
          <View marginB-s3>
            ...
            <SegmentedControl
              ...
              onChangeIndex={this.onChangeIndexColors}
            />
          </View>
        </View>
  ...
  getDynamicFieldStyle = (context: FieldContextType, props: TextFieldProps) => {
    ...
    return props?.preset === TextField.presets.UNDERLINE
    ...
    return (
      <>
        ...
        <TextField
          ...
          bottomAccessory={
            <Text text100>
              {Assets.emojis.grapes} {Assets.emojis.melon}{' '}
              {Assets.emojis.banana}
            </Text>
          }
    ...
    return (
      <>
        ...
        <TextField
          ...
          centered
          topTrailingAccessory={
            <Icon source={Assets.icons.demo.info} size={16} marginL-s1 />
          }
          validate={'required'}
  ...
  render() {
    return (
      <TestSuite name="TextField">
        <TestCase itShould="default">
          <View padding-20>{this.renderDefaultExample()}</View>
        </TestCase>
        <TestCase itShould="Preset">
          <View padding-20>{this.renderPresetExample()}</View>
        </TestCase>
        ...
        <TestCase itShould="ClearButton">
          <View padding-20>{this.renderClearButtonExample()}</View>
        </TestCase>
        <TestCase itShould="CharCounter">
          <View padding-20>{this.renderCharCounterExample()}</View>
        </TestCase>
        ...
        <TestCase itShould="DynamicField">
          <View padding-20>{this.renderDynamicFieldExample()}</View>
        </TestCase>
        <TestCase itShould="Formatter">
          <View padding-20>{this.renderFormatterExample()}</View>
        </TestCase>
        <TestCase itShould="CustomAlignment">
          <View padding-20>{this.renderCustomAlignmentExample()}</View>
        </TestCase>
      </TestSuite>
    );
  }
