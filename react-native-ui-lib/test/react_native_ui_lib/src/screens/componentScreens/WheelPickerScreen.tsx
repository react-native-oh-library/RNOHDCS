...
const WheelPickerScreen = () => {
  ...
  return (
    <TestSuite name="WheelPicker">
      <TestCase itShould="activeTextColor, inactiveTextColor, numberOfVisibleRows: 3">
        <View padding-20>
...
export default gestureHandlerRootHOC(WheelPickerScreen);
