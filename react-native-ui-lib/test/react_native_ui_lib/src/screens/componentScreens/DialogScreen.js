...
export default class DialogScreen extends Component {
  ...
  getWarning = () => {
    ...
    if (!showHeader && scroll !== this.SCROLL_TYPE.NONE) {
      return (
        <Text color={Colors.$textDangerLight}>
    ...
    const data = (
      <View spread flex={scroll !== this.SCROLL_TYPE.NONE}>
        <View marginT-20 marginH-20>
          ...
          <Text $textDefault marginT-20={!showHeader}>
            {this.getMessage()}
          </Text>
          {this.getWarning()}
        </View>
            ...
            <ScrollView>
              <View flex padding-2>
                ...
                <RadioGroup
                  marginT-20
                  initialValue={scroll}
                  onValueChange={this.setScroll}>
                  <Text $textDefault>Scroll:</Text>
                  <View row marginV-10>
                    <RadioButton value={this.SCROLL_TYPE.NONE} label={'None'} />
                    <RadioButton
                      value={this.SCROLL_TYPE.VERTICAL}
                      label={'Vertical'}
                      marginL-10
                    />
                    <RadioButton
                      value={this.SCROLL_TYPE.HORIZONTAL}
                      label={'Horizontal'}
                      marginL-10
                    />
                  </View>
                ...
                <View row marginT-20 centerV>
                  ...
                  <Switch
                    value={showHeader}
                    onValueChange={this.toggleShowHeader}
                    marginL-10
                  />
                </View>
                ...
                <View row marginT-20 centerV>
                  ...
                  <Switch
                    value={isRounded}
                    onValueChange={this.toggleIsRounded}
                    marginL-10
                  />
                </View>
                ...
                <View row marginT-20 centerV>
                  ...
                  <Switch
                    value={ignoreBackgroundPress}
                    onValueChange={this.toggleIgnoreBackgroundPress}
                    marginL-10
                  />
                </View>
