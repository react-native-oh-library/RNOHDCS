...
export default class ModalScreen extends Component<ModalScreenProps, State> {
  ...
  render() {
    return (
      <TestSuite name="Modal, Modal.TopBar">
            ...
            <View flex>
              ...
              <Carousel
                ...
                <View bg-violet80 flex style={styles.page}>
                  ...
                  <View padding-20>
                    <Text text70>
                      ...
                      cancelIcon, cancelLabel, doneIcon, doneLabel and other
                      props..
                    </Text>
                  </View>
                </View>
                ...
                <View bg-orange70 flex style={styles.page}>
                  ...
                  <View padding-20>
                    <Text text70>
                      Sending onDone/onCancel is required for rendering
                      done/cancel actions
                    </Text>
                  </View>
                </View>
                ...
                <View bg-grey70 flex style={styles.page}>
                  <Modal.TopBar
                    ...
                    cancelButtonProps={{
                      iconStyle: {tintColor: Colors.orange30},
                    }}
                  />
                  <View padding-20>
                    <Text text70>
                      use doneButtonProps/cancelButtonProps properties to have
                      custom behaviour or style for done/cancel actions
                    </Text>
                  </View>
                </View>
                ...
                <View bg-yellow80 flex style={styles.page}>
                  ...
                  <View padding-20>
                    <Text text70>
                      This is an example for using the rightButtons and
                      leftButtons props for having more than one button each
                      side
                    </Text>
                  </View>
                </View>
