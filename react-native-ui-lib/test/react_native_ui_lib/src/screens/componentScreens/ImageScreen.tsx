...
class ImageScreen extends Component<{}, State> {
      ...
      if (cover) {
        return (
          <View
            padding-20
            flex
            bottom={overlayType === Image.overlayTypes.BOTTOM}>
            <View row centerV>
              <Icon
        ...
        return (
          <Icon style={{margin: 5}} source={Assets.icons?.demo?.camera || ''} />
        );
      }
    }
  }
  ...
  renderOptions() {
    return (
      <>
        ...
        <View row spread>
          {renderRadioGroup.call(this, 'Overlay Type', 'overlayType', {
            none: 'none',
            ...Image.overlayTypes,
          })}
          {renderRadioGroup.call(
            ...
            'Overlay Intensity',
            'overlayIntensity',
            Image.overlayIntensityType,
          )}
        </View>
        {renderSliderOption.call(this, 'Margin(margin-XX)', 'margin', {
          step: 4,
          min: 0,
          max: 40,
        })}
        {renderSliderOption.call(this, 'Border Radius', 'borderRadius', {
          step: 5,
          min: 0,
          max: 100,
        })}
  ...
  renderSvgOptions() {
    return (
      <>
        {renderRadioGroup.call(this, 'SVG Type', 'svgType', SvgType, {
          isRow: true,
        })}
        {renderRadioGroup.call(this, 'Size Type', 'sizeType', SizeType, {
          isRow: true,
        })}
      </>
    );
