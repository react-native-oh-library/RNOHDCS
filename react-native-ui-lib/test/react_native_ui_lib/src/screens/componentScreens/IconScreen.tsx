      ...
      <TestCase itShould="例子:">
        <View padding-20>
          <View padding-page>
            ...
            {renderBooleanOption('Custom Size', 'customSize', {
              spread: false,
              state: customSize,
              setState: setCustomSize,
            })}
            <Slider
              maximumValue={100}
              value={24}
            ...
            <View marginV-s5>
              ...
              {renderBooleanOption('Use Badge:', 'useBadge', {
                spread: false,
                state: useBadge,
                setState: setUseBadge,
              })}
              {renderBooleanOption('Pimple Badge', 'showLabel', {
                spread: false,
                state: usePimple,
                setState: setUsePimple,
              })}
            </View>
          </View>
        </View>
