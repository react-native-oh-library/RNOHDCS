...
> {
  ...
  renderComplexExample = () => {
    return _.map(posts, (post, i) => {
      const statusColor =
        post.status === 'Published' ? Colors.$textSuccess : Colors.$textMajor;
  ...
  render() {
    return (
      <TestSuite name="Card">
        <TestCase itShould="Selectable Cards, selected, onPress">
          <View padding-20 centerH>
            {this.renderSelectableCards()}
          </View>
        </TestCase>
        <TestCase itShould="Horizontal Cards, borderRadius, containerStyle">
          <View padding-20 centerH>
        ...
        <TestCase itShould="Card Sections">
          <View padding-20 centerH>
            {this.renderCoupons()}
            {this.renderComplexImages()}
          </View>
        </TestCase>
        {/* <TestCase itShould="Others">
          <View padding-20 centerH>
