...
class DrawerScreen extends Component {
  ...
  render() {
    ...
    if (showRightItems) {
      drawerProps.rightItems = [
        {...ITEMS.delete, onPress: this.deleteItem},
        ITEMS.archive,
      ];
    }
    ...
    return (
      <TestSuite name="Drawer">
        <TestCase itShould="设置 rightItems, leftItem">
          <View padding-20>
            <Drawer
              rightItems={[
                {
