...
class DateTimePickerScreen extends Component<{}, State> {
  ...
  getCustomInputValue = (value?: string) => {
    ...
    return value.includes((new Date().getFullYear() + 1).toString())
      ? 'Next Year'
      : value;
  };
  ...
  toggleFormatter = () => {
    this.setState({
      dateTimeFormatter:
        this.state.dateTimeFormatter === 'moment' ? 'light-date' : 'moment',
    });
  };
            ...
            <View padding-page>
              ...
              <View row marginV-20 centerV spread>
                <View row>
                  ...
                  <Switch
                    value={mode === 'time'}
                    onValueChange={this.toggleTimeOrDate}
                    marginL-10
                  />
                </View>
                <View row>
                  ...
                  <Switch
                    value={dateTimeFormatter === 'moment'}
                    onValueChange={this.toggleFormatter}
                    marginL-10
                  />
                </View>
              </View>
...
export default gestureHandlerRootHOC(DateTimePickerScreen);
