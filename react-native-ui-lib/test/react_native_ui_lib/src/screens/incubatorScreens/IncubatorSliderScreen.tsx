...
const IncubatorSliderScreen = () => {
  ...
  const [negativeSliderValue, setNegativeSliderValue] =
    useState(NEGATIVE_VALUE);
    ...
    return (
      <>
        ...
        <ColorSliderGroup
          ...
          containerStyle={[
            styles.group,
            {borderWidth: 12, borderColor: groupColor},
          ]}
          showLabels
  ...
  return (
    <TestSuite name="IncubatorSlider">
      <TestCase itShould="">
        <ScrollView
          ...
          <View marginL-20>
            {Constants.isRTL &&
              renderBooleanOption('Disable RTL', 'disableRTL', {
                spread: false,
                state: disableRTL,
                setState: setDisableRTL,
              })}
          </View>
...
export default gestureHandlerRootHOC(IncubatorSliderScreen);
