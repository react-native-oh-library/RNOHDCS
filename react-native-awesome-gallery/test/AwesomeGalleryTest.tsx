...
export const TestCase = {
    ...
    AwesomeGalleryDoubleTapScale2Test: '测试[doubleTapScale]属性, 设置doubleTapScale=2, 双击后图片放大两倍',
    AwesomeGalleryDoubleTapScale3Test: '测试[doubleTapScale]属性, 设置doubleTapScale=3, 双击后图片放大三倍',
    AwesomeGalleryDoubleTapInterval400Test: '测试[doubleTapInterval]属性, 设置doubleTapInterval=400, 两次点击之间最大间隔400ms算双击',
    AwesomeGalleryDoubleTapInterval1000Test: '测试[doubleTapInterval]属性, 设置doubleTapInterval=1000, 两次点击之间最大间隔1000ms算双击',
    ...
    AwesomeGalleryDoubleTapEnabledTrueTest: '测试[doubleTapEnabled]属性, 设置doubleTapEnabled=true, 可以双击放大图片',
    AwesomeGalleryDoubleTapEnabledFalseTest: '测试[doubleTapEnabled]属性, 设置doubleTapEnabled=false, 无法双击放大图片',
    AwesomeGalleryDisableTransitionOnScaledImageTrueTest: '测试[doubleTapEnabled]属性, 设置doubleTapEnabled=false, 无法双击放大图片',
    ...
    AwesomeGalleryOnTranslationYChangeTest: '测试[onTranslationYChange], 当图片垂直方向位置有移动时将触发onTranslationYChange事件',
    AwesomeGalleryOnTapTest: '测试[onTap], 当点击图片时触发onTap事件',
    AwesomeGalleryOnDoubleTapTest: '测试[onDoubleTap], 当双击图片时触发onDoubleTap事件',
