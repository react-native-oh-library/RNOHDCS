...
const AutoLinkExample = () => {
    ...
    const renderLink = (text: string, match: Match, index: number) => (
        <Text key={index} style={styles.link} onPress={() => Linking.openURL('https://baidu.com/')}>
            {text}
        </Text>
    );
        ...
        <View>
            <ScrollView>
                <Tester>
                    ...
                    <TestCase itShould="linkProps: linkProps backgroundColor is yellow" tags={['C_API']} >
                        <View style={{ height: 40 }}>
                            <Autolink
                                text="This is the string to parse for urls (https://github.com/joshswan/react-native-autolink)"
                                linkProps={styles.container}
                            />
                        </View>
                    </TestCase>
                    <TestCase itShould="linkProps: linkProps url is baidu" tags={['C_API']} >
                        <View style={{ height: 40 }}>
                            <Autolink
                                text="This is the string to parse for urls (https://github.com/joshswan/react-native-autolink)"
                                linkProps={linkProps}
