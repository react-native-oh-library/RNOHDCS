        ...
        <Tester>
          <ScrollView>
            <TestSuite name='react-native-zoomable-view'>
              ...
              {tester_change("双击判定间隔最大时间 doubleTapDelay : 300",'300',()=>{ _setState({...state,doubleTapDelay:300}) })}
              {tester_change("双击判定间隔最大时间 doubleTapDelay : 500",'500',()=>{ _setState({...state,doubleTapDelay:500}) })}
              {tester_change("双击判定间隔最大时间 doubleTapDelay : 10000",'10000',()=>{ _setState({...state,doubleTapDelay:10000}) })}
