    ...
    return (
      <TouchableHighlight>
        <View style={[styles.row]}>
          ...
          <Text
            style={styles.peripheralId}
          >{`${item.advertising.isConnectable}`}</Text>
          <TestCase.Manual
          ...
          <TestCase.Manual
            ...
            arrange={({ setState }) => (
              <Button
                onPress={() => {
                  ReactNativeBleManager.retrieveServices(item.id, [
          ...
          <TestCase.Manual
            ...
            arrange={({ setState }) => (
              <Button
                onPress={async () => {
                  const res =
                    await ReactNativeBleManager.getBondedPeripherals();
          ...
          <TestCase.Manual
            ...
            arrange={({ setState }) => (
              <Button
                onPress={async () => {
                  const res =
                    await ReactNativeBleManager.getConnectedPeripherals();
                  setState(res.length > 0 ? true : false);
                  setResult(JSON.stringify(res));
                }}
          ...
          <TestCase.Manual
            ...
            arrange={({ setState }) => (
              <Button
                onPress={async () => {
                  const res =
                    await ReactNativeBleManager.getDiscoveredPeripherals();
                  setState(res.length > 0 ? true : false);
                  setResult(JSON.stringify(res));
                }}
          ...
          <TestCase.Manual
            ...
            arrange={({ setState }) => (
              <Button
                onPress={() => {
                  ReactNativeBleManager.writeDescriptor(
                    item.id,
                    "00001888-0000-1000-8000-00805F9B34FB",
                    "00001820-0000-1000-8000-00805F9B34FB",
          ...
          <TestCase.Manual
            ...
            arrange={({ setState }) => (
              <Button
                onPress={() => {
                  ReactNativeBleManager.readDescriptor(
                    item.id,
                    "00001888-0000-1000-8000-00805F9B34FB",
                    "00001820-0000-1000-8000-00805F9B34FB",
                    "00002903-0000-1000-8000-00805F9B34FB"
          ...
          <TestCase.Manual
            ...
            arrange={({ setState }) => (
              <Button
                onPress={() => {
                  ReactNativeBleManager.readRSSI(item.id)
                    .then((res) => {
          ...
          <TestCase.Manual
            ...
            arrange={({ setState }) => (
              <Button
                onPress={() => {
                  ReactNativeBleManager.startNotification(
                    item.id,
                    "00001888-0000-1000-8000-00805F9B34FB",
                    "00001820-0000-1000-8000-00805F9B34FB"
                  ).then(() => {
          ...
          <TestCase.Manual
            ...
            arrange={({ setState }) => (
              <Button
                onPress={() => {
                  ReactNativeBleManager.isPeripheralConnected(item.id, [
                    "00001888-0000-1000-8000-00805F9B34FB",
                  ]).then((res) => {
                    setResult(JSON.stringify(res));
                    setState(res);
