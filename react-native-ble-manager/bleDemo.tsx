...
import { Peripheral } from '@react-native-oh-tpl/react-native-ble-manager';
                    ...
                    <TestCase.Manual
                        ...
                        arrange={({ setState }) =>
                            <Button onPress={async () => {
                                await ReactNativeBleManager.connect(item.id);
                                setState(100)
        ...
        <Tester>
            <TestSuite name='Ble.manager'>
                ...
                <TestCase.Manual
                    ...
                    arrange={({ setState }) =>
                        <Button onPress={async () => {
                            await ReactNativeBleManager.start();
                            setState(100)
                        }} label={'start'}></Button>
                    }
                    assert={({ expect, state }) => {
                ...
                <TestCase.Manual
                    ...
                    arrange={({ setState }) =>
                        <Button onPress={async () => {
                            await ReactNativeBleManager.scan(
