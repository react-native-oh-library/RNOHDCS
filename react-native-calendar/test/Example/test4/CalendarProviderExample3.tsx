    ...
    return <ScrollView style={styles.calendar}>
        ...
        <Tester>
            <TestSuite name='showTodayButton'>
                <TestCase itShould="test CalendarProvider showTodayButton property with the  disabledOpacity:0.1 ">
                    <CalendarProvider
        ...
        <Tester>
            <TestSuite name='disabledOpacity'>
                <TestCase itShould="test CalendarProvider disabledOpacity property with the  disabledOpacity:0.9  ">
                    <CalendarProvider
