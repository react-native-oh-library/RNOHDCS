...
export function WeekCalendarExample() {
    return <ScrollView style={styles.container}>
        ...
        {/* <Tester>
            <TestSuite name='hideDayNames'>
                <TestCase itShould="test WeekCalendarExample hideDayNames property with the value true">
        ...
        <Tester>
            <TestSuite name='hideDayNames'>
                <TestCase itShould="test WeekCalendarExample hideDayNames property with the value false">
