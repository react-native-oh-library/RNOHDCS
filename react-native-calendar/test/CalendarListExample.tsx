    ...
    return <ScrollView style={styles.container}>
        ...
        <Tester>
            <TestSuite name='calendarHeight'>
                <TestCase itShould="test CalendarList calendarHeight property with value 300">
                    <CalendarList
                        calendarHeight={300}
                    />
                </TestCase>
        ...
        <Tester>
            <TestSuite name='calendarWidth'>
                <TestCase itShould="test CalendarList calendarWidth property with value 260">
                    <CalendarList
                        calendarWidth={260}
                    />
                </TestCase>
