...
export function CalendarProviderExample() {
    ...
    return <ScrollView style={styles.container}>
        ...
        <Tester>
            <TestSuite name='date'>
                <TestCase itShould="test CalendarProvider date property">
                    <CalendarProvider date={INITIAL_DATE_ONE}>
        ...
        <Tester>
        <TestSuite name=" showTodayButton,todayButtonStyle,disabledOpacity and todayButtonStyle ">
          <TestCase itShould="test CalendarProvider some properties">
