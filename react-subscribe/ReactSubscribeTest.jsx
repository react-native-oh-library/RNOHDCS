    ...
    <Tester style={{ flex: 1 }}>
      ...
      <TestSuite name="ReactSubscribeFetchTest1">
        <TestCase
          ...
          <ReactSubscribeFetchTest url={encodeURI('http://10.51.115.57:8888/student/getStuInfo?value=GET请求使用json处理返回数据')} method={"GET"} type={'json'} contentType={'application/json'}/>
        </TestCase>
      </TestSuite>
      <TestSuite name="ReactSubscribeFetchTest2">
        <TestCase
          ...
          <ReactSubscribeFetchTest url='http://10.51.115.57:8888/student/getStuInfo' method={"GET"} type={'json'} manners={1}/>
        </TestCase>
      </TestSuite>
      <TestSuite name="ReactSubscribeFetchTest3">
        <TestCase
          ...
          <ReactSubscribeFetchTest url='http://10.51.115.57:8888/student/postStuInfo' method={"POST"} type={'json'} body={JSON.stringify({"name":"post请求json返回"})} contentType={'application/json'}/>
        </TestCase>
      </TestSuite>
      <TestSuite name="ReactSubscribeFetchTest4">
        <TestCase
          ...
          <ReactSubscribeFetchTest url='http://10.51.115.57:8888/student/putStuInfo' method={"PUT"} type={'json'} body={JSON.stringify({"name":"PUT请求json返回"})} contentType={'application/json'}/>
        </TestCase>
      </TestSuite>
      <TestSuite name="ReactSubscribeFetchTest5">
        <TestCase
          ...
          <ReactSubscribeFetchTest url='http://10.51.115.57:8888/student/deleteStuInfo' method={"DELETE"} type={'json'} body={JSON.stringify({"name":"DELETE请求json返回"})} contentType={'application/json'}/>
        </TestCase>
      </TestSuite>
      <TestSuite name="ReactSubscribeFetchTest6">
        <TestCase
          ...
          <ReactSubscribeFetchTest url={encodeURI('http://10.51.115.57:8888/student/getStuInfo?value=GET请求使用blob方法处理返回数据')} method={"GET"} type={'blob'} contentType={'application/json'}/>
        </TestCase>
      </TestSuite>
      <TestSuite name="ReactSubscribeFetchTest7">
        <TestCase
          ...
          <ReactSubscribeFetchTest url={encodeURI('http://10.51.115.57:8888/student/getStuInfo?value=GET请求使用text处理返回数据')} method={"GET"} type={'text'} contentType={'application/json'}/>
        </TestCase>
      </TestSuite>
