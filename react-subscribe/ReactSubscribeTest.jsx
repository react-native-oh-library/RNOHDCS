...
import {ReactSubscribeSubscribeDomTest} from './ReactSubscribeSubscribeDomTest';
...
export const ReactSubscribeTest = () => {
  return (
    <Tester style={{ flex: 1 }}>
      ...
      <TestSuite name="ReactSubscribeSubscribeDomTest">
        <TestCase
          tags={['C_API']}
          itShould="触摸Touch me1时count1加1,触摸Touch me2时count2加1 ">
          <ReactSubscribeSubscribeDomTest/>
        </TestCase>
      </TestSuite>
    </Tester>
  );
