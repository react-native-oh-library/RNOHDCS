        ...
        <View style={{ marginVertical: height / 8 }}>
          <View style={styles.view}>
            <Tooltip
              ...
              withPointer={false}
            >
              <Text style={{ color: 'black' }}>without caret</Text>
            </Tooltip>
            <Tooltip
              visible={open2}
              onOpen={() => {
          ...
          <View style={styles.view}>
            ...
            >
              <Text style={{ color: 'black' }}>HUGE</Text>
            </Tooltip>
          </View>
          <View style={styles.view}>
            <Tooltip
              ...
              popover={<Text>Tooltip info goes here</Text>}
            >
              <Text style={{ color: 'black' }}>More attention</Text>
            </Tooltip>
          </View>
          <View style={styles.view}>
            <Tooltip
              ...
              popover={<Text>Tooltip info goes here</Text>}
            >
              <Text style={{ color: 'black' }}>I'm different</Text>
            </Tooltip>
            <Tooltip
              visible={open7}
              onOpen={() => {
