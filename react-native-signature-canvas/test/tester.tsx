...
export function AndroidLayerType() {
  return (
    <ScrollView>
      <Tester style={{flex: 1}}>
        <TestSuite name="SignatureScreen">
          <TestCase itShould="androidLayerType:(none)" tags={['C_API']}>
            <View style={{height: 400}}>
              <Text>设置 android webview 的 layerType none</Text>
              <SignatureScreen androidLayerType="none" />
            </View>
          </TestCase>
          <TestCase itShould="androidLayerType:(software)" tags={['C_API']}>
            <View style={{height: 400}}>
              <Text>设置 android webview 的 layerType software </Text>
              <SignatureScreen androidLayerType="software" />
            </View>
          </TestCase>
          <TestCase itShould="androidLayerType:(hardware)" tags={['C_API']}>
            <View style={{height: 400}}>
              <Text>设置 android webview 的 layerType hardware </Text>
              <SignatureScreen androidLayerType="hardware" />
            </View>
          </TestCase>
        </TestSuite>
      </Tester>
...
export function AndroidHardwareAccelerationDisabled() {
  return (
    <ScrollView>
      <Tester style={{flex: 1}}>
        <TestSuite name="SignatureScreen">
          <TestCase
            itShould="androidHardwareAccelerationDisabled:(true)"
            tags={['C_API']}>
            <View style={{height: 400}}>
              <Text>android硬件加速 true </Text>
              <SignatureScreen androidHardwareAccelerationDisabled />
            </View>
          </TestCase>
          <TestCase
            itShould="androidHardwareAccelerationDisabled:(false)"
            tags={['C_API']}>
            <View style={{height: 400}}>
              <Text>android硬件加速 false </Text>
              <SignatureScreen />
            </View>
          </TestCase>
        </TestSuite>
...
export function MinDistance() {
  return (
    <ScrollView>
      <Tester style={{flex: 1}}>
        <TestSuite name="SignatureScreen">
          <TestCase itShould="MinDistance:numbe(10)" tags={['C_API']}>
            <View style={{height: 400}}>
              <Text>
                仅当前一个点距离大于 x 像素时才添加下一个点。默认为 5{' '}
              </Text>
              <SignatureScreen minWidth={0.5} maxWidth={1} minDistance={10} />
            </View>
          </TestCase>
          <TestCase itShould="MinDistance:numbe(1)" tags={['C_API']}>
            <View style={{height: 400}}>
              <Text>
                仅当前一个点距离大于 x 像素时才添加下一个点。默认为 5{' '}
              </Text>
              <SignatureScreen minWidth={0.5} maxWidth={1} minDistance={1} />
            </View>
          </TestCase>
        </TestSuite>
      </Tester>
...
export function NestedScrollEnabled() {
  ...
  return (
    <ScrollView>
      <Tester style={{flex: 1}}>
        <TestSuite name="SignatureScreen">
          <TestCase itShould="nestedScrollEnabled :true" tags={['C_API']}>
            <ScrollView>
              <Text>
                启用嵌套滚动以在滚动视图中使用 nestedScrollEnabled= (true){' '}
              </Text>
              <Text>滚动视图</Text>
              <Text>滚动视图</Text>
              <Text>滚动视图</Text>
              ...
              <SignatureScreen
                ...
                customHtml={() => {
                  return `<div>
                   <div style=" background-color: white;height:400;">
                    <p>this is customHtml</p>
                   </div>
                   <div style=" background-color: white;height:400;">
                    <p>this is customHtml</p>
          ...
          <TestCase itShould="nestedScrollEnabled :false" tags={['C_API']}>
            <ScrollView>
              <Text>
                启用嵌套滚动以在滚动视图中使用 nestedScrollEnabled= (false){' '}
              </Text>
              <Text>滚动视图</Text>
              <Text>滚动视图</Text>
              <Text>滚动视图</Text>
  ...
  return (
    <ScrollView>
      <Tester style={{flex: 1}}>
        <TestSuite name="SignatureScreen">
          <TestCase
            itShould="showsVerticalScrollIndicator :true"
            tags={['C_API']}>
            <ScrollView>
              <Text>是否显示垂直滚动指示符(true)</Text>
              <Text>滚动视图</Text>
              <Text>滚动视图</Text>
              <Text>滚动视图</Text>
              <Text>滚动视图</Text>
          ...
          <TestCase
            itShould="showsVerticalScrollIndicator :false"
            tags={['C_API']}>
            <ScrollView>
              <Text>是否显示垂直滚动指示符(false)</Text>
              <Text>滚动视图</Text>
              <Text>滚动视图</Text>
              <Text>滚动视图</Text>
              <Text>滚动视图</Text>
...
export function OnDraw() {
  ...
  const [onDraw, setonDraw] = useState('绘制时触发回调');
  return (
    <ScrollView>
      <Tester style={{flex: 1}}>
        <TestSuite name="SignatureScreen">
...
export function TrimWhitespace() {
  ...
  return (
    <ScrollView>
      <Tester style={{flex: 1}}>
        <TestSuite name="SignatureScreen">
          <TestCase itShould="trimWhitespace:boolean" tags={['C_API']}>
