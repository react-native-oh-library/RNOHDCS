...
const dataImage = [
    {
        caption: 'Caption 1',
        source: require('./static/images/1.png'),
        dimensions: { width: 540, height: 720 },
        width: "100%", height: "100%",
    },
    {
        caption: 'Caption 2',
        source: { uri: 'https://p0.ssl.qhimgs1.com/sdr/400__/t0461b1cfd7e4ef2b66.jpg' },
    ...
    { caption: 'Caption 4', source: { uri: 'https://img.zcool.cn/community/01d191576ccecb0000018c1b64e382.jpg@1280w_1l_2o_100sh.jpg' } },
    { caption: 'Caption 5', source: { uri: 'https://octodex.github.com/images/Robotocat.png' } },
    { caption: 'Caption 6', source: { uri: 'https://res6.vmallres.com/pimages//uomcdn/CN/pms/202210/gbom/6942103100642/800_800_5F6A0ADEF3722AEE3026EE7DD5457F62mp_tds.png' } }
]
...
const dataImage1err = [
    {
        caption: 'Caption 2',
        source: { uri: 'https://tse4-mm.cn.bing.net/t12h/id/OIP-C.e6iItqBlqt6l6K261WPMXAHaFj?w=227&h=180&c=7&r=0&o=5&pid=1.71' }
    }
]
...
const TestonPageScrollStateChanged = () => {
    return (
        <Gallery
            images={dataImage}
...
const TestonSingleTapConfirmed = () => {
    return (
        <Gallery
            images={dataImage}
            ...
            <ScrollView>
                <Tester>
                    <TestSuite name="reactnativeimagegalleryTest">
                        <TestCase.Example itShould="TEST imageComponent">
                                <MyGallery />
                        </TestCase.Example>
                        <TestCase.Example itShould="TEST errorComponent ">
                                <TestErrorComponent />
                        </TestCase.Example>
                        <TestCase.Example itShould="TEST InitialPage ">
                                <TestInitialPage />
                        </TestCase.Example>
                        <TestCase.Example itShould="TEST TestPageMargin ">
                                <TestPageMargin />
                        </TestCase.Example>
                        <TestCase.Example itShould="TEST FlatListProps ">
                                <TestFlatListProps />
                        </TestCase.Example>
                        <TestCase.Example itShould="TEST PageScrollStateChanged ">
                                <TestonPageScrollStateChanged />
                        </TestCase.Example>
                        <TestCase.Example itShould="TEST onPageScroll ">
                                <TestonPageScroll />
                        </TestCase.Example>
                        <TestCase.Example itShould="TEST scrollViewStyle ">
                                <TestscrollViewStyle />
                        </TestCase.Example>
                        <TestCase.Example itShould="TEST onSingleTapConfirmed ">
                                <TestonSingleTapConfirmed />
                        </TestCase.Example>
                        <TestCase.Example itShould="TEST onLongPress ">
                                <TestonLongPress />
                        </TestCase.Example>
                    </TestSuite>
                </Tester>
...
const images = [
    ...
    { caption: 'Caption 2', source: { uri: 'https://img.zcool.cn/community/01d191576ccecb0000018c1b64e382.jpg@1280w_1l_2o_100sh.jpg' } },
    { caption: 'Caption 3', source: { uri: 'https://octodex.github.com/images/Robotocat.png' } },
    { caption: 'Caption 4', source: { uri: 'https://res6.vmallres.com/pimages//uomcdn/CN/pms/202210/gbom/6942103100642/800_800_5F6A0ADEF3722AEE3026EE7DD5457F62mp_tds.png' } }
