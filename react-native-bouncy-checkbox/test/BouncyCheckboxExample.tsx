...
export default function BouncyCheckboxExample() {
    ...
    return <ScrollView style={styles.container}>
        ...
        <TestSuite name='style'>
                <TestCase itShould="test BouncyCheckbox style property with value borderWidth: 1,borderColor: '#007aff'">
                    <BouncyCheckbox
            ...
            <TestSuite name='textStyle'>
                    <TestCase itShould="test BouncyCheckbox textStyle property with value fontSize: 30,color: '#010101'">
                <BouncyCheckbox
                    text="please press me!"
            ...
            <TestSuite name='iconStyle'>
                <TestCase itShould="test BouncyCheckbox iconStyle property with value borderColor: green,borderWidth: 8,borderRadius: 0">
                    <BouncyCheckbox
                    iconStyle={{
                        borderColor: "green",
                        borderWidth: 8,
            ...
            <TestSuite name='innerIconStyle'>
                <TestCase itShould="test BouncyCheckbox innerIconStyle property with value borderWidth: 5, borderColor: red ">
                    <BouncyCheckbox
            ...
            <TestSuite name='textContainerStyle'>
                <TestCase itShould="test BouncyCheckbox textContainerStyle property with value backgroundColor: 'lightblue',borderWidth: 5">
                    <BouncyCheckbox
