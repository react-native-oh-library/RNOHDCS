...
export function CardTest() {
    ...
    const CardProps = [
        ...
        {
            key: 'Card stylet: delayLongPress is 1000(延时长按1秒)',
            value: {
                mode: 'contained' as 'elevated' | 'outlined' | 'contained',
                onLongPress: _onLongPress,
                delayLongPress: 1000
    ...
    return (
        <ScrollView>
            <Tester>
                ...
                <TestSuite name='Card theme test'>
                    <TestCase itShould='Card theme: { roundness: 1 }'>
                        <Card style={{margin: 8}} theme={{ roundness: 1 }}>
                            <Card.Title title={'Card title'} ></Card.Title>
                        </Card>
                    </TestCase>
                    <TestCase itShould='Card theme: { roundness: 8 }'>
                        <Card style={{margin: 8}} theme={{ roundness: 8 }}>
                            <Card.Title title={'Card title'} ></Card.Title>
                        </Card>
                    </TestCase>
                    <TestCase itShould='Card.Title theme: { isV3: false }'>
                        <Card style={{margin: 8}} >
                            <Card.Title title={'Card title'} theme={{ isV3: false }}></Card.Title>
                        </Card>
                    </TestCase>
                    <TestCase itShould='Card.Title theme: { isV3: true }'>
                        <Card style={{margin: 8}} >
                            <Card.Title title={'Card title'} theme={{ isV3: true }}></Card.Title>
                        </Card>
                    </TestCase>
                    <TestCase itShould='Card.Ations theme: { isV3: ture } '>
                        <Card style={{margin: 8}} >
                            <Card.Actions theme={{isV3: true}}>
                                <Button>Cancel</Button>
                                <Button>Ok</Button>
                            </Card.Actions>
                        </Card>
                    </TestCase>
                    <TestCase itShould='Card.Ations theme: { isV3: false } '>
                        <Card style={{margin: 8}} >
                            <Card.Actions theme={{isV3: false}}>
                                <Button>Cancel</Button>
                                <Button>Ok</Button>
                            </Card.Actions>
                        </Card>
                    </TestCase>
                    <TestCase itShould='Card.Cover theme: { roundness: 0 } '>
                        <Card style={{margin: 8}} >
                            <Card.Cover
                            theme={ { roundness: 0 }}
                            source={ require('../assets/images/avatar.png') }
                    ...
                    <TestCase itShould='Card.Cover theme: { roundness: 50 } '>
                        <Card style={{margin: 8}} >
                            <Card.Cover
                            theme={ { roundness: 50 }}
                            source={ require('../assets/images/avatar.png') }
