    ...
    CodePush.sync(
      {
        ...
        updateDialog: {
          ...
          mandatoryUpdateMessage: '更新通知', //- 强制更新时，更新通知. Defaults to “An update is available that must be installed.”.
        },
      },
    ...
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity onPress={this.syncImmediate.bind(this)}>
          <Text style={styles.syncButton}>属性 mandatoryUpdateMessage</Text>
        </TouchableOpacity>
        {progressView}
      </View>
    );
