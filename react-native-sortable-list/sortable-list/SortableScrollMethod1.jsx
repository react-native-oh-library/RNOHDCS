...
export default function SortableScrollMethod1() {
      ...
      <TestSuite name="Test scrollBy">
        <TestCase itShould={`Test scrollBy  scrollTo scrollToRowKey`}>
          <View style={{height: 150, marginBottom: 10}}>
            ...
            <Button
              style={styles.button}
              title={`scrollTo({x: 0,y: 100,animated: true})`}
              onPress={() => {
