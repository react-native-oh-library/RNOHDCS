...
import * as PickerHarmonyExamples from './PickerHarmonyExample';
    ...
    <SafeAreaView style={styles.main}>
      <ScrollView>
        ...
        <View style={styles.container}>
          ...
          {Platform.OS === 'harmony' && (
            <Text style={styles.heading}>PickerHarmony Examples</Text>
          )}
          {Platform.OS === 'harmony' &&
            PickerHarmonyExamples.examples.map((element) => (
              <View style={styles.elementContainer} key={element.title}>
                <Text style={styles.title}> {element.title} </Text>
                {element.render()}
              </View>
