...
import { StyleSheet, Text, View, Image, Animated, Dimensions, Easing, ScrollView } from 'react-native';
...
function ScrollViewComponent() {
    ...
    return (
        <Tester>
            <TestSuite name='ScrollViewComponent 传入一个ScrollView组件'>
                <TestCase itShould='ScrollViewComponent'>
                    <View style={{ height: 1000 }}>
                        <ImageHeaderScrollView
                            ...
                            ScrollViewComponent={MyComponent}
                        >
                            <>
                                <TriggeringView
