                    ...
                    <TestCase  itShould='onBeginHidden & onBeginDisplayed'>
                        <View style={{ height:1000}}>
                            ...
                            >
                                <>
                                    <TriggeringView
                                        onBeginHidden={() => HeaderRef?.current?.fadeInUp(100)}
                                        onBeginDisplayed={() => HeaderRef?.current?.fadeOut(100)}
                                    >
...
export default TriggeringViewOnBeginHiddenAndOnBeginDisplayed;
