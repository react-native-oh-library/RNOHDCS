import React, {
  ...
  export const  MyImageScrollView: FunctionComponent<Props> = forwardRef(
    (
      {
        overlayColor = 'black',
      ...
      const renderHeader = () => {
        ...
        console.log('11111111111xxxxx',disableHeaderGrow,headerScale,headerTransformStyle,useNativeDriver)
        const overlayStyle = [
          styles.overlay,
      ...
      const renderTouchableFixedForeground = () => {
        ...
        return (
          <Animated.View style={[styles.header, styles.touchableFixedForeground, { height }]}>
            {renderTouchableFixedForegroundProps() as any}
          </Animated.View>
        );
      };
