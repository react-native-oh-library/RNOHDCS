...
export function SystemDenseWeightsExample() {
  return (
    <Tester>
      <ScrollView>
        <TestSuite name="react-native-typography systemDenseWeights">
          {Object.entries(systemDenseWeights).map((data: any,index) => {
