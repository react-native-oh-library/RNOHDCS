...
class doneButtonHitslop extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      <View style={styles.container}>
        ...
        doneButtonStyle={styles.doneButton}
          onDone={this.handleFocusNext}
          doneButtonHitslop={{ left: 200, top: 23, right: 10, bottom: 10 }}
          avoidKeyboard
          androidAdjustResize
        />
      </View>
...
doneButtonHitslop.navigationOptions = {
  title: 'doneButtonHitslop',
}
