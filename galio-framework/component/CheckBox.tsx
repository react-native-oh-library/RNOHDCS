...
const CheckBoxDemo = () => {
    ...
    const CheckBoxProps = [
        ...
        { image: "https://avatars.githubusercontent.com/u/155599655?v=4&size=64", imageStyle: { width: 50, height: 50 } },
        { image: "https://github.githubassets.com/assets/gh-desktop-7c9388a38509.png", imageStyle: styles.imageStyle },
        { initialValue: true },
        { initialValue: false },
        { label: "row checkbox" },
        { label: 'label' },
        { labelStyle: { color: 'red' }, label: "row checkbox" },
        { labelStyle: { fontSize: 20, color: 'blue' }, label: 'label' },
        { onChange: onChange, label: 'onChange' }
    ]
    return (
