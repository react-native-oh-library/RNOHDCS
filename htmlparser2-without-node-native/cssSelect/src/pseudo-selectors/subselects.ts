...
import { cacheParentResults } from "../helpers/cache";
import type { CompiledQuery, InternalOptions, CompileToken } from "../types";
import { isTraversal, includesScopePseudo } from "../helpers/selectors";
import { findOne, getNextSiblings } from "../helpers/querying";
