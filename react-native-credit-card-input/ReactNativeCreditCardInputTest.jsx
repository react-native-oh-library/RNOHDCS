    ...
    <ScrollView>
      ...
      <TestSuite name="CreditCardInput3">
        <TestCase
          ...
          <View>
            <CreditCardInput labels={{ number: "CARD NUMBERTest", expiry: "EXPIRYTest", cvc: "CVC/CCVTest" }} />
          </View>
        </TestCase>
      </TestSuite>
      <TestSuite name="CreditCardInput4">
        <TestCase
          ...
          <View>
            <CreditCardInput placeholders={{ number: "2222 2222 2222 2222", expiry: "MM/YYTest", cvc: "CVCTest" }} />
          </View>
        </TestCase>
      </TestSuite>
      ...
      <TestSuite name="CreditCardInput6">
        <TestCase
          ...
          <View>
            <CreditCardInput cardFontFamily="HarmonyOS Sans" />
          </View>
        </TestCase>
      </TestSuite>
      ...
      <TestSuite name="CreditCardInput12">
        <TestCase
          tags={['C_API']}
          itShould="CreditCardInput中 validColor 属性，设置cvc文本输入完后蓝色">
          <View>
      ...
      <TestSuite name="CreditCardInput13">
        <TestCase
          tags={['C_API']}
          itShould="CreditCardInput中 invalidColor 属性，设置number文本和expipy输入完后字体为蓝色">
          <View>
      ...
      <TestSuite name="CreditCardInput20">
        <TestCase
          tags={['C_API']}
          itShould="CreditCardInput中 cardBrandIcons 属性，设置jcb执行是图片">
          <View>
            <CreditCardInput cardBrandIcons ={
              {
                jcb: require("./icons/stp_card_cvc.png"),
              }
            } />
          </View>
        </TestCase>
