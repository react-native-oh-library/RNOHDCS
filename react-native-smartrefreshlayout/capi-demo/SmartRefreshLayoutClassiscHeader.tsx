...
import { SmartRefreshControl, ClassicsHeader } from '@react-native-oh-tpl/react-native-smartrefreshlayout/src/index';
...
itamArray.push({ id: 9, text: "设置ClassicsHeader黄色主题", dec: "设置ClassicsHeader黄色主题" });
itamArray.push({ id: 10, text: "设置ClassicsHeader绿色字体主题", dec: "设置ClassicsHeader绿色字体主题" });
itamArray.push({ id: 11, text: "设置ClassicsHeader白色字体主题", dec: "设置ClassicsHeader白色字体主题" });
const App = () => {
  ...
  let classSmartRefreshControlRef: React.RefObject<SmartRefreshControl> = useRef(null);
  ...
  return (
    <View >
      <SmartRefreshControl
        ref={classSmartRefreshControlRef}
        primaryColor={color}
        autoRefresh={autuR}
        ...
        onRefresh={() => {
          ...
          setTimeout(() => {
            classSmartRefreshControlRef.current.finishRefresh({ delayed: -1, success: true });
          }, 5000);
        }}
