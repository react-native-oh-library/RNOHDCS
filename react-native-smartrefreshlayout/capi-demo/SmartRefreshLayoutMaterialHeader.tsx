...
import { SmartRefreshControl, MeaterialHeader } from '@react-native-oh-tpl/react-native-smartrefreshlayout/src/index';
...
const App = () => {
  ...
  let meaterRefreshControlRef: React.RefObject<SmartRefreshControl> = useRef(null);
