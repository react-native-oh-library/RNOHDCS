...
const Meun = [
  ...
  },
  {
    ...
    onPress: (setState: (arg0: boolean) => void) => {
      AsyncStorage.setItem('test_mergeItem',JSON.stringify({name: 'lili', age: 20}));
      AsyncStorage.mergeItem('test_mergeItem',JSON.stringify({name: 'lili', age: 21, sex: 'women'}),error => {
        setState(!error);
      });
    },
  },
