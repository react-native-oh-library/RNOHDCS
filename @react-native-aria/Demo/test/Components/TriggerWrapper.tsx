...
import { View, Text, Pressable, ScrollView, Modal, StyleSheet, TouchableWithoutFeedback } from "react-native";
...
export default function TriggerWrapper({ setState }: any) {
    ...
    return <Trigger placement={positions[placement]} setState={setState}></Trigger>;
}
...
export function Trigger({ placement, setState }: any) {
    ...
    return (
        <View style={{ flexDirection: 'row', alignItems: "center" }} >
            ...
            <Modal visible={toggleState.isSelected} onRequestClose={() => { toggleState.toggle(); setState(true) }}>
                <OverlayProvider>
                    <OverlayContainer>
                        <OverlayView targetRef={ref} placement={placement} />
                        <TouchableWithoutFeedback
                            onPress={() => { toggleState.toggle(); setState(true) }}
                            accessible={false}
